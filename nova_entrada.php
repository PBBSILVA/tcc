                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="row justify-content-between text-left">
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         ...
                                         <input type="text" required disabled class="form-control" style="text-align: right;" value="0,00" name="valor_nota" id="valor_nota">
                                       </div>
                                    ...
                                    <div class="row justify-content-between text-left">
                                       ...
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         ...
                                         <input type="text" required disabled class="form-control" style="text-align: right;" value="0,00" name="total_nota" id="total_nota">
                                       </div>
                                    </div>
