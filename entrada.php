...
<div id="layoutSidenav">
                        ...
                        <div class="row" <?= (!isset($_GET["sucesso_atualizar"]) ? 'style="padding-top: 15px"' : '') ?>>
                            <div class="col-xl-8">
                                <div class="card mb-4">
                                    ...
                                    <div class="row justify-content-between text-left">
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         <label style="padding-left: 5px" class="form-control-label">Valor da Nota<span class="text-danger"> *</span></label>
                                         <input type="text" required disabled class="form-control" style="text-align: right;" value="<?= number_format($valor_nota, 2, ',', '.') ?>" name="valor_nota" id="valor_nota">
                                       </div>
                                    
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         <label style="padding-left: 5px" class="form-control-label">Acr&eacute;scimos (+)<span class="text-danger"> *</span></label>
                                         <input type="text" required class="form-control" style="text-align: right;" value="<?= number_format($acrescimos, 2, ',', '.') ?>" name="acrescimos" onKeyUp="atualizar_dados_nota()" onBlur="formatarCampo(this)" id="acrescimos">
                                       </div>
                                    </div>   
                                    ...
                                    <div class="row justify-content-between text-left">
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         ...
                                         <input type="text" OnKeyUp="atualizar_dados_nota()" onBlur="formatarCampo(this)" required class="form-control" style="text-align: right;" value="<?= number_format($descontos, 2, ',', '.') ?>" name="descontos" id="descontos">
                                       </div>
                                    
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         <label style="padding-left: 5px" class="form-control-label">Total da Nota<span class="text-danger"> *</span></label>
                                         <input type="text" required disabled class="form-control" style="text-align: right;" value="<?= number_format($total_nota, 2, ',', '.') ?>" name="total_nota" id="total_nota">
                                       </div>
                                    </div>
    ...
    <div class="modal-dialog" style="width: 60%;">
		...
		// funçao que atualiza o preço total do item sendo inserido
		...
		// fim atulaiza o preço total do item sendo inserido
		
		// funçao que atualiza os dados da nota
		...
		// funçao que permite adicionar um novo produto a esta entrada
		function adicionarProduto(){
		  ...
		  // vamos chamar um código Ajax para inserir este item na tabela itens_entrada
          ...
          $.ajax({
            ...
            success: function(data){
			  $(data).find('mensagem').each(function(){
				...
				// atualiza as informaçoes da entrada
				...
				// fim atualizar as informaçoes da entrada  
		  ...
		  // fim chamar um código Ajax para inserir este item na tabela itens_entrada	
	    }
		
		var $modal_excluir_item_entrada = $('#janela_excluir_item_entrada');
        // dados temporários para exclusao do item da entrada
		var referencia_temp;
		...
		// funçao que permite remover um produto desta entrada
		function confirmar_exclusao_item_entrada(){
		  ...
		  // fim chamar um código Ajax para remover este item da tabela itens_entrada	
	    }
