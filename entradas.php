					   ...
					   <?php
                         ...
                         if($resultado_paginacao){
                            while($detalhes = mysqli_fetch_array($resultado_paginacao)){
							   ...
							   echo '<td style="vertical-align: middle" nowrap="nowrap" align="left">' . $num_nota . '</td>';
							   ...
							   echo '<td style="vertical-align: middle" nowrap="nowrap" align="right">' . number_format($valor_nota, 2, ',', '.') . '</td>';
							   ...
							   echo '<td style="vertical-align: middle" nowrap="nowrap" align="right">' . number_format($total_nota, 2, ',', '.') . '</td>';
