...
$id_produto = tratar_entrada((trim($_POST["id_produto"])));
$referencia = tratar_entrada(trim($_POST["referencia"]));
$nome = tratar_entrada((trim($_POST["nome"])));
$descricao = tratar_entrada((trim($_POST["descricao"])));
$categoria = tratar_entrada((trim($_POST["categoria"])));

// trata o preço
$preco_venda = tratar_entrada((trim($_POST["preco_venda"])));
$preco_venda = str_replace(".", "", $preco_venda);
$preco_venda = str_replace(",", ".", $preco_venda);
// fim tratar o preço

$estoque_minimo = tratar_entrada( (trim($_POST["estoque_minimo"])));
$unidade = tratar_entrada( (trim($_POST["unidade"])));
$foto = tratar_entrada( (trim($_POST["foto"])));
