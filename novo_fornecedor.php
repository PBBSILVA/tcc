...
<head>
  ...
  <title><?= $titulo_aplicacao ?> - Novo Fornecedor</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h1 class="mt-4"><i class="bi-truck"></i> Novo Fornecedor</h1>
                        ...
                        <div class="alert alert-success" role="alert">
                          O fornecedor foi cadastrado com sucesso. Voce pode agora verificar os <a href="fornecedores.php" class="alert-link">
                            Fornecedores Cadastrados</a> ou continuar cadastrando mais fornecedores.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                <div class="card mb-4">
                                    ...
                                    <form id="cadastro_fornecedor" nome="cadastro_fornecedor" action="cadastrar_fornecedor_action.php" method="post" class="form-card">
                                    
                                    <div class="row justify-content-between text-left">
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         <label style="padding-left: 5px" class="form-control-label">Nome Fantasia<span class="text-danger"> *</span></label>
                                         <input onkeyup="atualizar_info_lado()" required type="text" id="fantasia" name="fantasia" placeholder="">
                                       </div>
                                    
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         <label style="padding-left: 5px" class="form-control-label">Raz&atilde;o Social<span class="text-danger"> *</span></label>
                                         <input onkeyup="atualizar_info_lado()" required type="text" id="razao_social" name="razao_social" placeholder="">
                                       </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-between text-left">
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         ...
                                         <input onkeyup="atualizar_info_lado()" required type="text" id="cpf_cnpj" name="cpf_cnpj" placeholder="">
                                       </div>
                                    ...
                                    <div class="row justify-content-between text-left">
                                       ...
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         ...
                                         <input onkeyup="atualizar_info_lado()" required type="text" id="endereco" name="endereco" placeholder="">
                                       </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-between text-left">
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         ...
                                         <input onkeyup="atualizar_info_lado()" required type="text" id="cidade" name="cidade" placeholder="">
                                       </div>
                                       
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         <label style="padding-left: 5px" class="form-control-label">Estado<span class="text-danger"> *</span></label>
                                         <input onkeyup="atualizar_info_lado()" required type="text" id="estado" name="estado" placeholder="">
                                       </div>
                                    </div>   
                            ...
                            <div class="col-xl-4">
                                <div class="card mb-4">
                                    ...
                                    <div style="background-image: url('imagens/fundo_fotos.jpg'); background-repeat: repeat-x; text-align:center" class="image_area">
								      <form method="post">
									    <label for="upload_image">
										   <img width="150px" src="imagens/fornecedor_sem_foto.jpg" id="uploaded_image" class="rounded-circle" style="width:200;" />
									     <div class="overlay">
                                    ...
                                    <table width="100%">
                                      ...
                                      <tr>  
                                        <td align="center"><span id="foto_fantasia_fornecedor"></span></td>
                                      </tr>
                                      <tr>
                                        <td align="center"><span id="foto_cidade_estado_fornecedor"></span></td>
                                      </tr>
                                      <tr>
                                        <td style="padding-top: 15px" align="center"><span id="foto_info_fornecedor"></span></td>
                                      </tr>
                                    </table>
