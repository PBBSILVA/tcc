                         ...
                         if($resultado_paginacao){
                            while($detalhes = mysqli_fetch_array($resultado_paginacao)){
							   ...
							   if(file_exists($diretorio_fotos_produtos . '/' . $foto . '.png')){
								  ...
								  $foto = '<img title="Clique para mais detalhes" width="40px" src="' . $url_base_aplicacao . '/imagens/produto_sem_foto.jpg" class="rounded-circle" />'; 
							   }
							   ...
							   echo '<td style="vertical-align: middle" nowrap="nowrap" align="right">' . number_format($preco_compra, 2, ',', '.') . '</td>';
							   echo '<td style="vertical-align: middle" nowrap="nowrap" align="right">' . number_format($preco_venda, 2, ',', '.') . '</td>';
							   echo '<td style="vertical-align: middle" nowrap="nowrap" align="right">' . number_format($lucro, 1, ',', '.') . '%</td>';
							   echo '<td style="vertical-align: middle" nowrap="nowrap" align="right">' . $estoque . '</td>';
							   echo '<td style="vertical-align: middle" nowrap="nowrap" align="right">' . $estoque_min . '</td>';
