                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                <div class="card mb-4">
                                    ...
                                    <div class="row justify-content-between text-left">
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         <label style="padding-left: 5px" class="form-control-label">Pre&ccedil;o Venda<span 
                                         class="text-danger"> *</span></label>
                                         <input type="text" name="preco_venda" value="<?= number_format($preco_venda, 2, ',', '.') ?>" 
                                            required id="preco_venda" style="text-align: right;">  
                                       </div>
                                       
                                       <div class="form-group col-sm-6 flex-column d-flex">
                                         <label style="padding-left: 5px" class="form-control-label">Lucro<span 
                                           class="text-danger"> *</span></label>
                                         <input type="text" name="lucro" disabled value="<?= number_format($lucro, 1, ',', '.') ?>% (R$ <?= number_format($preco_venda - $preco_compra, 2, ',', '.') ?>)" 
                                           required id="lucro" style="text-align: left;">
                                       </div>
                                    </div>
